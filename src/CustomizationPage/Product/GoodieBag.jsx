...
const GoodieBag = ({
	...
	const getImageSource = (color) => {
		if (color === "white") {
			return "src/CustomizationPage/Product/images/whitebag.png";
		} else if (color === "brown") {
			return "src/CustomizationPage/Product/images/brownbag.png";
		} else if (color === "red") {
			return "src/CustomizationPage/Product/images/redbag.png";
		}
	};
